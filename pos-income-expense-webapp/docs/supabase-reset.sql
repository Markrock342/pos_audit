...
('55555555-5555-5555-5555-555555555501', '11111111-1111-1111-1111-111111111111', 'income',  'ค่าสินค้า',                    '#4CAF50', 10, TRUE),
('55555555-5555-5555-5555-555555555502', '11111111-1111-1111-1111-111111111111', 'income',  'ค่าขนส่ง',                    '#2196F3', 20, TRUE),
('55555555-5555-5555-5555-555555555503', '11111111-1111-1111-1111-111111111111', 'income',  'รายได้อื่น',                  '#8BC34A', 30, TRUE),
('55555555-5555-5555-5555-555555555505', '11111111-1111-1111-1111-111111111111', 'expense', 'ค่าพนักงาน',                  '#B22222', 10, TRUE),
('55555555-5555-5555-5555-555555555506', '11111111-1111-1111-1111-111111111111', 'expense', 'ค่าเช่าที่',                  '#708090', 20, TRUE),
('55555555-5555-5555-5555-555555555507', '11111111-1111-1111-1111-111111111111', 'expense', 'ค่าสินค้า (ซื้อเข้า)',         '#4682B4', 30, TRUE),
('55555555-5555-5555-5555-555555555508', '11111111-1111-1111-1111-111111111111', 'expense', 'ค่าใช้จ่ายอื่น',               '#9E9E9E', 40, TRUE);
