...
export default function LoginPage() {
  return (
    <div className="flex h-screen flex-col items-center justify-between bg-surface px-6 py-3 overflow-hidden">
      {/* Logo Header */}
      ...
      {/* Footer */}
      <p className="text-center text-xs font-bold text-text-muted shrink-0">
